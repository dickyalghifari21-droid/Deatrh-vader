...
class _AttackPageState extends State<AttackPage> with TickerProviderStateMixin {
  ...
  // 🔥 TAMBAHKAN INI UNTUK ASSISTIVE MENU 🔥
  Color get kNavy      => kBg;  // atau Colors.black.withOpacity(0.8)
  Color get kNavyCard  => kCard;
  Color get kNavyBorder=> kCardBorder;
  Color get kCyan      => kRedLight;
  Color get kText      => Colors.white;
  
Offset _assistiveTouchPosition = const Offset(20, 150);
bool   _isAssistiveMenuOpen    = false;
String _activePage             = 'bug';
  ...
  return Scaffold(
    ...
    body: Stack(
      children: [
        ...
        // ========== ASSISTIVE MENU (DISMISS OVERLAY) ==========
        ...
        AnimatedPositioned(
          ...
          top: isBottomSide ? _assistiveTouchPosition.dy - 380 : _assistiveTouchPosition.dy,
          child: AnimatedScale(
        ...
        // ========== ASSISTIVE TOUCH BUTTON (TOM BOL LINGKARAN) ==========
        Positioned(
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              height: 58,
              decoration: BoxDecoration(
                color: _isAssistiveMenuOpen ? kNavyCard : Colors.black.withOpacity(0.55),
...
// ========== HEADER BARU (Halo, Dilz + LIVE + Role) ==========
Widget _buildHeader() {
  return Container(
...
Widget _buildAssistiveMenu() {
  final cur = widget.role.toLowerCase();
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _assistiveMenuItem(Icons.home, "Beranda", 'home'),
              _assistiveMenuItem(FontAwesomeIcons.whatsapp, "Bug Nomor", 'bug'),
              _assistiveMenuItem(FontAwesomeIcons.paperPlane, "Spam", 'telegram'),
              _assistiveMenuItem(Icons.phone_android, "RAT (Tikus)", 'rat'),
              _assistiveMenuItem(FontAwesomeIcons.screwdriverWrench, "Tools", 'tools'),
              _assistiveMenuItem(Icons.code, "Test Func", 'testfunc'),
              ...
              if (canSeller) _assistiveMenuItem(Icons.store, "Seller Panel", 'reseller'),
              if (canAdmin) _assistiveMenuItem(Icons.admin_panel_settings, "Admin Panel", 'admin'),
              _assistiveMenuItem(Icons.person_add_alt_1, "Add Sender", 'add_sender'),
              _assistiveMenuItem(Icons.palette_outlined, "Color Settings", 'color'),
...
Widget _assistiveMenuItem(IconData icon, String title, String page) {
  ...
  return Padding(
    ...
    child: Material(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(12),
        splashColor: kRedLight.withOpacity(0.15),
        onTap: () {
        ...
        child: Container(
          ...
          decoration: isActive
              ? BoxDecoration(
                  color: kRedLight.withOpacity(0.08),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(color: kRedLight.withOpacity(0.25)),
                )
              : null,
          child: Row(
            children: [
              Icon(icon, color: isActive ? kRedLight : Colors.white54, size: 18),
              const SizedBox(width: 16),
              Expanded(
                child: Text(
                  title,
...
void _navigateToPage(String page) {
  switch (page) {
    case 'home':
      ...
      break;
    case 'bug':
      // sudah di halaman bug
      break;
    case 'telegram':
      // navigasi ke SpamPage
      break;
    case 'rat':
      // navigasi ke RAT page
      break;
    case 'tools':
      // navigasi ke Tools page
      break;
    case 'ddos':
      // navigasi ke DDoS page
      break;
    case 'account':
      _showAccountMenu();
      break;
    case 'add_sender':
      // navigasi ke Add Sender page
      break;
    case 'color':
  ...
  return Positioned(
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: [
          _bottomNavItem(Icons.home_filled, "Beranda", 'home'),
          _bottomNavItem(FontAwesomeIcons.whatsapp, "Kesalahan", 'bug'),
          _bottomNavItem(FontAwesomeIcons.paperPlane, "Spam", 'telegram'),
          _bottomNavItem(Icons.phone_android, "Tikus", 'rat'),
          _bottomNavItem(Icons.more_horiz, "Lainnya", 'more'),
        ],
      ),
    ),
  );
...
Widget _bottomNavItem(IconData icon, String label, String page) {
  final isActive = _activePage == page;
  return GestureDetector(
    onTap: () {
      if (page == 'home') {
    ...
    child: Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Icon(icon, color: isActive ? kRedLight : Colors.white54, size: 20),
        const SizedBox(height: 4),
        Text(label, style: TextStyle(color: isActive ? kRedLight : Colors.white54, fontSize: 10)),
      ],
    ),
  );
}
